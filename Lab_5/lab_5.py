...
print(f"Jumlah Kata: {results['word_count']}")
print(f"Jumlah Kata Unik: {results['unique_word_count']}")
print(f"Kata yang Salah Eja: {results['misspelled_words']}")